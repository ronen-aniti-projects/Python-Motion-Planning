    ...
    def save_trajectory_to_files(self, relative_path):
        ...
        with open(relative_path + 'x_position.csv', 'w') as f:
            for i in range(len(self.points)-1):
                f.write(','.join([str(c) for c in self.x_dict[i]['position']]) + '\n')
...
if __name__ == "__main__":
    ...
    waypoints = [(0, 0, 0), (20, 10, 10), (20, -20, 20), (30, 40, 10)] # Change waypoints here
